...
@section('content')
 ...
 @can('articulos.create')
        <a href="{{ route('admin.articulos.create') }}" class="btn btn-primary mb-2">Crear Productos</a>
        
  @endcan
     <a class="btn btn-danger mb-2" href="{{ route('print_barcode') }}" target="_blank"> PDF </a>
