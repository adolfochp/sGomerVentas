...
@section('content_header')
    ...
    <h1>Listado de VentaServicio</h1>
@stop

@section('content')
    @can('compras.create')
        <a class="btn btn-primary mb-2" href="{{ route('admin.compras.create') }}">+ Registrar servicio</a>
    @endcan
    @if (session('success'))
                    ...
                    @foreach ($compras as $compra)
                        <tr>
                            ...
                            <td style="width:100px;">
                                ...
                                @endcan
                                @can('compras.show')
                                    <a href="{{ route('admin.compras.show', $compra) }}" class="btn btn-info">Detalles <i
