        ...
        <div class="form-group">
            ...
            <select class="form-control selectpicker articuloB" data-live-search="true" name="articulo_id"
                ...
                @foreach ($articulos as $articulo)
                    <option value="{{ $articulo->id }}_{{ $articulo->stock }}_{{ $articulo->precio_ventservicio }}">
...
<div class="form-row">
    ...
    <div class="form-group col-md-3">
        <div class="form-group">
            <label for="precio_venta">Precio de venta Servicio</label>
            <input type="number" class="form-control" name="precio_ventservicio" id="precio_ventservicio" aria-describedby="helpId"
                disabled>
        </div>
    </div>
</div>
...
<div class="form-group mt-4">
    <h4 class="card-title">Detalles de venta Servicio</h4>
