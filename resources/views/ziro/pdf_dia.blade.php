...
<body>
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            <tr>
                <td colspan="2" style="text-align: center">
                    <span style="font-size: 25px; font-weight: bold; ">SVS-Gomer-Su </span>
                </td>
            </tr>
            <tr>
                <td style="vertical-align: top; padding-top:0px; position: relative; width: 20%;">
                    <img style="width: 250px" src="imagen/logo-mueble-reporte.png" alt="logo-reporte.png" width="400"
                        height="250">
                </td>
                <td style="vertical-align: top; padding-top: 10px; width: 80%;">
                    ...
                    <span style="font-size: 16px;"><strong>Fecha de consulta:
                            {{ \Carbon\Carbon::now()->format('d/m/Y') }}</strong></span><br>
                    {{-- <span style="font-size: 14px;">Usuario: {{ $venta->user->name }}</span> --}}
                </td>
            </tr>
        </table>
    </section>
    <section class="datos">
        <div >
            <table  class="tabla" style="width: 100%; margin-top: 5px;">
